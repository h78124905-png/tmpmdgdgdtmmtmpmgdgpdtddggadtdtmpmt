...
# Build a genuinely optimized CPU path for comparison. GGML_NATIVE was
# previously forced OFF, which prevents architecture-specific CPU kernels.
replace_once(
    "set(GGML_NATIVE OFF CACHE BOOL \"\" FORCE)",
    "set(GGML_NATIVE ON CACHE BOOL \"\" FORCE)",
)

print("Applied CPU/Vulkan selector, target-only benchmark switch, CPU optimization, and LFM2.5 thinking parser fix")
